interface Window {
  ...
  addEventListener(type: 'push', listener: ((event: PushEvent) => ReturnTypeOrItself<Parameters<typeof addEventListener>[1]>), options?: Parameters<typeof addEventListener>[2]): ReturnType<typeof addEventListener>
