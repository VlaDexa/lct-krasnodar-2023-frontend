...
export class UserService {
	 ...
	 * @throws ApiError
	 */
	public static registerApiV1UserRegisterPost(requestBody: UserBase): CancelablePromise<TokensOut> {
	 ...
	 * @throws ApiError
	 */
	public static deleteUserApiV1UserDelete(userId: string): CancelablePromise<UserShow> {
		return __request(OpenAPI, {
			method: 'DELETE',
			url: '/api/v1/user/',
			query: {
