...
export class AchievementsService {
	 ...
	 * @throws ApiError
	 */
	public static getAchievementApiV1AchievementsGet(id: string): CancelablePromise<any> {
	 ...
	 * @throws ApiError
	 */
	public static getFileApiV1AchievementsGetFileGet(id: string): CancelablePromise<any> {
		return __request(OpenAPI, {
			method: 'GET',
